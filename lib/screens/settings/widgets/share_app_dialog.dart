    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(Constants.appName, style: TextStyle(fontSize: 24, fontFamily: 'OpenSans', fontWeight: FontWeight.bold, color: Color(0xff056380)),),
          const SizedBox(height: 10),
          Text(AppLocalizations.of(context)!.share, style: TextStyle(fontSize: 18, fontFamily: 'OpenSans'),),
                ...
                ElevatedButton.icon(
                  onPressed: () async {
                    final shareResult = await SharePlus.instance.share(
                      ShareParams(
                        text: "${AppLocalizations.of(context)!.shareMessage} : https://play.google.com/store/apps/details?id=com.grey.rate_master",
                      ),
                    );
